...
if "image" in response.headers.get("Content-Type", ""):
    ...
    st.sidebar.warning("⚠️ Sidebar image not available. Please check sharing settings.")
...
st.plotly_chart(pieChart, use_container_width=True) # Added use_container_width
